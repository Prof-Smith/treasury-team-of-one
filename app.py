...
✕ Override policy''')
    if completed==len(steps): jump_button('Open human control gate →',5)
    ...
    w1,w2,w3,w4=st.columns(4); w1.metric('Messages connected',8); w2.metric('Attachments processed',10); w3.metric('Mappings proposed',27); w4.metric('Material exceptions',6)
